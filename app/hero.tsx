...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[250px] items-start bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-cyan-200 via-cyan-100 to-cyan-50 pb-10 sm:items-center sm:pb-0">
      <div className="container flex flex-col-reverse items-center sm:flex-row">
        <div className="flex w-full flex-col justify-center gap-5 sm:w-1/2">
          <div className="flex flex-col gap-3 text-center sm:text-left">
            <h1 className="text-lg font-bold text-emerald-600 sm:text-start sm:text-base lg:text-xl xl:text-2xl">
              Selamat datang di produk KWT
              <br />
              Desa Pasir Biru 🪴
            </h1>
          ...
          <div className="flex w-full justify-center sm:justify-start">
            <Button
              ...
              className="flex gap-3 bg-emerald-500 text-white duration-300 hover:bg-emerald-600"
            >
              <FaBagShopping />
              Belanja Sekarang
            </Button>
